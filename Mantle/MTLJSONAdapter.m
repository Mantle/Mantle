...
- (id)initWithJSONDictionary:(NSDictionary *)JSONDictionary modelClass:(Class)modelClass error:(NSError **)error {
	...
	_JSONKeyPathsByPropertyKey = [_modelClass respondsToSelector:@selector(JSONKeyPathsByPropertyKey)] ? [[modelClass JSONKeyPathsByPropertyKey] copy] : @{};
...
- (id)initWithModel:(MTLModel<MTLJSONSerializing> *)model {
	...
	_JSONKeyPathsByPropertyKey = [_modelClass respondsToSelector:@selector(JSONKeyPathsByPropertyKey)] ? [[model.class JSONKeyPathsByPropertyKey] copy] : @{};
